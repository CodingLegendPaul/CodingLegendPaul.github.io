...
const workout = [
    ...
    {'time': 20, 'name': '1/10 Push-ups', 'image': "../Logos/Push-ups.gif"},
    {'time': 10, 'name': '2/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '2/10 Tricep dips', 'image': "../Logos/tricep-dips.gif"},
    {'time': 10, 'name': '3/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '3/10 Diamond push-ups', 'image': "../Logos/Push-ups.gif"},
    {'time': 10, 'name': '4/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '4/10 Up and down plank', 'image': "../Logos/plank.gif"},
    {'time': 10, 'name': '5/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '5/10 One leg push ups', 'image': "../Logos/onelegpush-up.gif"},
    {'time': 10, 'name': '6/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '6/10 Burpees', 'image': "../Logos/burpees.gif"},
