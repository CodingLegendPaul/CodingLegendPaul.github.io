...
const workout = [
    ...
    {'time': 20, 'name': '1/10 Jumping jacks', 'image': "../Logos/jumpingjack.gif"},
    {'time': 10, 'name': '2/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '2/10 Wall-sit', 'image': "../Logos/wallsit.gif"},
    ...
    {'time': 20, 'name': '4/10 Tricep-dips', 'image': "../Logos/tricep-dips.gif"},
