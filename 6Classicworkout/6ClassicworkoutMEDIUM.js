...
const workout = [
    ...
    {'time': 30, 'name': '1/10 Jumping jacks', 'image': "../Logos/jumpingjack.gif"},
    {'time': 10, 'name': '2/10 Rest', 'image': "../Logos/white.png"},
    {'time': 30, 'name': '2/10 Wall-sit', 'image': "../Logos/wallsit.gif"},
    {'time': 10, 'name': '3/10 Rest', 'image': "../Logos/white.png"},
    {'time': 30, 'name': '3/10 Push-ups', 'image': "../Logos/Push-ups.gif"},
    {'time': 10, 'name': '4/10 Rest', 'image': "../Logos/white.png"},
    {'time': 30, 'name': '4/10 Tricep-dips', 'image': "../Logos/tricep-dips.gif"},
    {'time': 10, 'name': '5/10 Rest', 'image': "../Logos/white.png"},
    {'time': 30, 'name': '5/10 Abdominal crunches', 'image': "../Logos/abdominal.gif"},
    {'time': 10, 'name': '6/10 Rest', 'image': "../Logos/white.png"},
    {'time': 30, 'name': '6/10 Leg raises', 'image': "../Logos/legraises.gif"},
