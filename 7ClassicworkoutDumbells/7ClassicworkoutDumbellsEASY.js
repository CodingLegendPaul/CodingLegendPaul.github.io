...
const workout = [
    ...
    {'time': 20, 'name': '1/10 Dumbbell hammer curl', 'image': "../Logos/hammercurl.gif"},
    {'time': 10, 'name': '2/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '2/10 Push-ups', 'image': "../Logos/Push-ups.gif"},
    {'time': 10, 'name': '3/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '3/10 Tricep-dips', 'image': "../Logos/tricep-dips.gif"},
    {'time': 10, 'name': '4/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '4/10 Bicep curl', 'image': "../Logos/bicep-curl.gif"},
    {'time': 10, 'name': '5/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '5/10 One Arm Dumbbell swing', 'image': "../Logos/dumbell-swing.gif"},
    {'time': 10, 'name': '6/10 Rest', 'image': "../Logos/white.png"},
    {'time': 20, 'name': '6/10 One Arm Dumbbell swing (other arm)', 'image': "../Logos/dumbell-swing.gif"},
